...
Then, I created a series of wordclouds, including a  "Matrix-style" inspired animated wordcloud ("tmwc" html file) to show the occurence of unique terms in the script. The most frequent word of all was "agent".
